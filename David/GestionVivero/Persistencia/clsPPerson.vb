...
Public Class clsPPerson
    ...
    Public Sub altaPersona(unP As clsPersona)
        ...
        consulta1 = "insert INTO empleado values (" & unP.cedula & ",'" & unP.user & "','" & unP.contra & "','" & unP.nombre & "','" & unP.direccion & "','" & unP.tele & "','" & unP.fecha & "','" & unP.cargo & "');"
    ...
    Private Function recrearPersona(fila As MySqlDataReader) As clsPersona
        ...
        unEmp.fecha = fila.GetString("fechanac")
        Return (unEmp)
    End Function
    '----------------------------------------------------------------------------------------------
